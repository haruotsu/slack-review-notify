...
- Language: %s`,
	...
	"modal.submit":                       "Save",
	"modal.close":                        "Cancel",
	"modal.header":                       "*Edit review notification settings for this channel*\nSettings are identified by label name. Matching an existing label updates it; otherwise a new entry is created.",
	"modal.label_name":                   "Label name",
	"modal.label_name.hint":              "e.g. needs-review. Matches existing label → update; else create.",
	...
	"modal.reviewer_reminder_interval":   "Reminder interval (minutes)",
	"modal.reviewer_reminder_interval.hint": "Positive integer, e.g. 30",
