...
func TestCheckPendingTasks(t *testing.T) {
	...
	// 関数を実行
	CheckPendingTasks(db)
	
	// アサーション - 更新されたことだけを確認
	var updatedTask models.ReviewTask
	db.Where("id = ?", "pending-test").First(&updatedTask)
