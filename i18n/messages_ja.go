...
- 言語: %s`,
	...
	"modal.submit":                       "保存",
	"modal.close":                        "キャンセル",
	"modal.header":                       "*このラベルのレビュー通知設定を編集します*\n対象ラベルは固定です。別ラベルを編集する場合は一度キャンセルし、スラッシュコマンドから該当ラベルを操作してください。ユーザーマッピングや away 設定は引き続きスラッシュコマンドから操作します。",
	"modal.label_name":                   "対象ラベル:",
	"modal.label_name.hint":              "対象ラベルは固定です。別ラベルはスラッシュコマンドで設定してください。",
	"modal.default_mention_id":           "メンション先 (ユーザーID / サブチーム ID)",
	"modal.default_mention_id.hint":      "例: U123456 または S0123456 (サブチーム)",
	"modal.reviewer_list":                "レビュワー (カンマ区切りのユーザーID)",
	"modal.reviewer_list.hint":           "例: U111,U222,U333",
