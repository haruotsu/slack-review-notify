...
- 言語: %s`,
	...
	"modal.submit":                       "保存",
	"modal.close":                        "キャンセル",
	"modal.header":                       "*このチャンネルのレビュー通知設定を編集します*\nラベル名で設定を識別します。既存ラベル名と一致すれば更新、それ以外は新規作成となります。",
	"modal.label_name":                   "ラベル名",
	"modal.label_name.hint":              "例: needs-review。既存ラベル名と一致すれば更新、無ければ新規作成。",
	...
	"modal.reviewer_reminder_interval":   "リマインド頻度 (分)",
	"modal.reviewer_reminder_interval.hint": "1以上の整数。例: 30",
