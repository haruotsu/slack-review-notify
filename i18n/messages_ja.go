...
- 言語: %s`,
	...
	"common.leave_type.am":      "午前休",
	"common.leave_type.pm":      "午後休",

	// ==================== Settings Modal ====================
	"modal.title":                           "レビュー通知設定",
	"modal.submit":                          "保存",
	"modal.close":                           "キャンセル",
	"modal.header":                          "*このチャンネルのレビュー通知設定を編集します*\nラベルごとに独立した設定が可能です。ユーザーマッピングや休暇設定 (set-away) は引き続きスラッシュコマンドから操作してください。",
	"modal.label_select":                    "編集対象ラベル",
	"modal.label_select.create_new":         "+ 新規ラベルを作成…",
	"modal.new_label_name":                  "新しいラベル名",
	"modal.new_label_name.hint":             "GitHub PR に付与されるラベル名と一致させる必要があります。",
	"modal.default_mention_user":            "メンション先 (個人)",
	"modal.default_mention_user.hint":       "Slack のユーザーピッカーから個人を選択。それ以外 (サブチーム / 装飾テキスト) は下の欄。",
	"modal.default_mention_text":            "メンション先 (その他)",
	"modal.default_mention_text.hint":       "サブチーム ID (S…)、@チーム名、装飾テキストなど自由入力可。上の個人選択が空欄の場合に使われます。実メンションにしたいサブチームは S… ID を貼ってください。",
	"modal.reviewer_list":                   "レビュワー候補 (ピッカー)",
	"modal.reviewer_list.hint":              "Slack のユーザーピッカーから個人レビュワーを複数選択。割当時はこの候補からランダムに選ばれます。",
	"modal.reviewer_list_text":              "レビュワー候補 (その他, カンマ区切り)",
	"modal.reviewer_list_text.hint":         "ID 形式じゃないレビュワー（旧データ等）はこちらに。ピッカーの選択と合わせて保存されます。",
	"modal.reminder_interval":               "レビュワー募集中のリマインド頻度 (分)",
	"modal.reminder_interval.hint":          "1以上の整数。レビュワーが未割当の間のリマインド頻度。",
	"modal.delete_config":                   "この設定を削除",
	"modal.delete_config.option":            "このラベル設定を削除する（保存時に実行されます）",
	"modal.repository_list":                 "通知対象リポジトリ (カンマ区切り)",
	"modal.repository_list.hint":            "例: owner/repo1, owner/repo2",
	"modal.reviewer_reminder_interval":      "レビュワー割当後のリマインド頻度 (分)",
	"modal.reviewer_reminder_interval.hint": "1以上の整数。例: 30。初回通知前のリマインドはスラッシュコマンドから設定します。",
	"modal.business_hours_start":            "営業開始時間",
	"modal.business_hours_end":              "営業終了時間",
	"modal.timezone":                        "タイムゾーン",
	"modal.timezone.hint":                   "例: Asia/Tokyo, UTC, America/New_York",
	"modal.required_approvals":              "必要なapprove数",
	"modal.required_approvals.hint":         "1〜10の整数",
	"modal.language":                        "言語",
	"modal.is_active":                       "通知を有効化",
	"modal.lang.ja":                         "日本語",
	"modal.lang.en":                         "English",
	"modal.active.true":                     "有効",
	"modal.active.false":                    "無効",
	"modal.open_button":                     "⚙️ 設定をUIで編集",
	"modal.saved":                           "ラベル「%s」の設定を保存しました 🎉",
	"modal.deleted":                         "ラベル「%s」の設定を削除しました 🗑️",
	...
	"modal.away.leave_type":               "休暇タイプ",
	"modal.away.leave_type.hint":          "半休の場合は午前休/午後休を選択してください。",
	"modal.away.leave_type.full_day":      "終日",
	"modal.away.leave_type.am":            "午前休",
	"modal.away.leave_type.pm":            "午後休",
	...
	"modal.away.error.half_day_multi_day": "半休は単日のみ指定できます。開始日と終了日を同じにしてください。",
	"modal.away.error.half_day_expired":   "指定された半休の時間帯は既に過ぎています。",
