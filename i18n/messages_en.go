...
- Language: %s`,
	...
	"modal.default_mention_id":           "Mention target",
	"modal.default_mention_id.hint":      "Accepts @username or @team-handle (subteam). U… / S… ID also OK.",
	"modal.reviewer_list":                "Reviewers (comma-separated)",
	"modal.reviewer_list.hint":           "Accepts @user1, @user2 display names. U… IDs also OK.",
