...
- 言語: %s`,
	...
	"modal.default_mention_id":           "メンション先",
	"modal.default_mention_id.hint":      "@haruotsu や @チーム名（サブチーム）でもOK。U… や S… の ID 直接入力も可能。",
	"modal.reviewer_list":                "レビュワー (カンマ区切り)",
	"modal.reviewer_list.hint":           "@user1, @user2 のように@マーク付き表示名で指定できます。U… の ID 直接入力も可能。",
