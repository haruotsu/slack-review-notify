...
- 言語: %s`,
	...
	"modal.default_mention_user.hint":    "Slack のユーザーピッカーから選択。サブチーム宛にしたい場合は下のフィールドに入れてください。",
	"modal.default_mention_subteam":      "メンション先 (サブチーム)",
	"modal.default_mention_subteam.hint": "サブチーム ID (S…) または @チーム名 を入力。上の個人選択が空欄の場合に使用されます。",
	"modal.reviewer_list":                "レビュワー候補",
	"modal.reviewer_list.hint":           "ユーザーピッカーから複数選択。割当時はこの中からランダムに選ばれます。",
