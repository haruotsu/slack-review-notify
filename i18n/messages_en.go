...
- Language: %s`,
	...
	"modal.default_mention_user.hint":    "Pick from Slack's user picker. If you want to mention a team (subteam) instead, use the field below.",
	"modal.default_mention_subteam":      "Mention target (subteam)",
	"modal.default_mention_subteam.hint": "Subteam ID (S…) or @team-handle. Used only when the user picker above is empty.",
	"modal.reviewer_list":                "Reviewer pool",
	"modal.reviewer_list.hint":           "Pick multiple users via Slack's picker. Reviewers are drawn randomly from this pool.",
