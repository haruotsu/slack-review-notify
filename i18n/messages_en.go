...
- Language: %s`,
	...
	"modal.submit":                       "Save",
	"modal.close":                        "Cancel",
	"modal.header":                       "*Edit review notification settings for this label*\nThe target label is fixed below. To edit a different label, cancel and run the slash command for that label. User mappings and away schedules are still managed via slash commands.",
	"modal.label_name":                   "Target label:",
	"modal.label_name.hint":              "Target label is fixed. Use the slash command to configure other labels.",
	"modal.default_mention_id":           "Mention target (user ID or subteam ID)",
	"modal.default_mention_id.hint":      "e.g. U123456 or S0123456 (subteam)",
	"modal.reviewer_list":                "Reviewers (comma-separated user IDs)",
	"modal.reviewer_list.hint":           "e.g. U111,U222,U333",
